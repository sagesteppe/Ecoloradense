...
Recent advances in remote sensing have narrowed this resolution gap, providing environmental predictors fine enough to generate useful models even in highly heterogeneous environments [CITE]. 
Further, these data offer promise for modelling additional population parameters (e.g., census size, population extent) [CITE]. 
However, the utility and use of high-resolution data have rarely been ground-verified or reported upon [@chiffard2020anbs].

The last several decades has seen enormous advances in the statistical and software tooling for generating robust environmental niche models (ENMs), and the volume of requisite data for modelling have likewise grown via high-resolution environmental data, citizen science, and the digitisation of natural history museum records [@markham2023review; @feldman2021trends].
However, despite these advances, ENMs are still rarely ground-verified, and seldom at landscape scales [@a2022species].
