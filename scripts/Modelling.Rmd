...
preds <- left_join(test_mean, preds, by = 'Lctn_bb')
Metrics::mae(preds$Observed, preds$Predicted)
...
ctrl <- caret::rfeControl(
  functions = caret::rfFuncs, method = "repeatedcv", repeats = 10,
  allowParallel = TRUE)
...
train <- select(train, c('Prsnc_All', predictors(rfProfile)))
