...
ctrl <- caret::rfeControl(
  ...
  method = "cv", 
  index = indices_knndm_CAST$indx_train, # NEEDS THE CAST OBJECT... 
  allowParallel = TRUE)
...
rec <- recipes::recipe(Prsnc_All ~ ., data = train) 
indx_knndm_rs <- CAST2rsample(indices_knndm_CAST, train)
