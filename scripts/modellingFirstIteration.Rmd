...
v <- data.frame(
  ...
  Trail = c(
    ...
    'Mt. Bellview', 'Frigid Air Pass', 'Treasury Mtn.', 'Hasley Pass', 'Rustlers Gulch & Virginia Basin', 
    '401', 'East Maroon Pass', 'Cassi Mines', 'Triangle Pass', 'North Pole Basin',
    'Red Rock', 'Cassi North', '13043 Ridge', '13043-Cassi Basin', ''
    )
)

left_join(trails, v, by = 'ID') %>% 
